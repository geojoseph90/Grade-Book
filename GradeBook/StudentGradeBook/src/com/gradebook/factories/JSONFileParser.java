	...
	public GradeBook parseFile(String fileLocation) {
	        ...
	        for(int i =0 ;i<studentArray.length();i++) {
	        	...
	        	for(int j= 0; j <assingnedWorkArray.length();j++) {
	        		...
	        		generalGradedWorkObject = assignedWorkObj.get("GradedWork");
	        		...
	        		assignedWork.setGradedWork(generalGradedWorkList);
			...
			//e.printStackTrace();
			//System.out.println("Problem parsing file. Please check the file and re-run the program.");
		}
